...
public class CollectorsDemo {
    public static void main(String[] args) {
       ...
       String concatenatedNames= names.stream().map(String::toUpperCase).collect(Collectors.joining(","));
        ...
        System.out.println(words.stream().collect(Collectors.groupingBy(String::length, Collectors.joining(",")))); // agar group ke sath kuch karna hai
        // Now it is a String to a List
        ...
        // Example 4. Summing values ina map
        ...
        // Example 6: Counting words using toMap instead of groupingBy
        List<String>words2=Arrays.asList("apple","banana","orange","banana","apple");
        System.out.println(words2.stream().collect(Collectors.toMap(k->k,v->1,(x,y)->x+y))); // It is merge function
